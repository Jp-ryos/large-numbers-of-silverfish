...
const bpfoldername = "large-numbers-of-silverfish";
...
const dedicatedServerPath = ""; // if using Bedrock Dedicated Server, where to find the extracted contents of the zip package
